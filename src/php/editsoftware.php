      ...
      <td class="tdtop">
        ...
        <table class="tbl2" style='width:300px;'>
          ...
          <tr>
            ...
            <td><input validate='required:true' class='mandatory dateinp' size=10 title='<?php echo $datetitle ?>' type=text name='purchdate' id='purchdate' value='<?php echo $d ?>'>
            </td>
          </tr>
