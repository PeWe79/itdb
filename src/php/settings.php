		...
		<?php 
			...
			if (isset($_POST['dateformat']) ) { 
				//if we came from a post (save), update the rack 
		...
		?>
			...
			<table class="tbl2" >
				<tr>
					<td colspan=2><h3><?php te("Settings"); ?></h3></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="tdt"><?php te("Date Format")?></td><td>
				...
				<tr>
					...
					<td>
						...
						(for authentication only, except user admin which is local)
					</td>
				</tr>
