...
?>
		...
		<?php
			...
			echo "<a href='$scriptdir?action=$action'>Go here</a></body></html>"; 
			exit;
			}
						...
						<div id="tabs-1">
							...
							<div id='selcontainer'>
								<?php
									...
									echo "
								<select id='selitems' class='monospaced' name='selitems[]' multiple=multiple size='$nitems'>";
									...
									if (((int)$r['status']==2)&& ($pstatus!=2)) {
										echo "<option disabled style='background-color:red;color:black;font-weight:bold;text-align:center'>Defective:</option>";
										$pstatus=(int)$r['status'];
									}
									elseif (((int)$r['status']==1) && ($pstatus!=1)) {
										echo "<option disabled style='background-color:#00BB5F;color:black;font-weight:bold;text-align:center'>Stored:</option>";
										$pstatus=(int)$r['status'];
									}
									elseif (((int)$r['status']==3) && ($pstatus!=3)) {
										echo "<option disabled style='background-color:#cecece;color:black;font-weight:bold;text-align:center'>Obsolete:</option>";
										$pstatus=(int)$r['status'];
									}
				...
				<div class='blue' style='float:left;margin-left:10px;'>
					<table class='propstable' border=0>
						...
						<tr>
							...
							<?php 
								...
								foreach ($labelpapers as $lp) {
									//echo $lp['id'];
									echo "<a href='javascript:ldata({$lp['rows']}, {$lp['cols']}, ".  
								...
								echo "
						<tr>
							<td class='tdt'>".t("Paper Size").":</td><td>";
						...
						<tr>
							...
							<td>
								<input id='wantbarcode' type=checkbox <?php if($wantbarcode) echo "CHECKED"; ?> name=wantbarcode>
