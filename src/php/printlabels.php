  ...
  <form method=post id='selitemsfrm' name='selitemsfrm'>
        ...
        <div id="tabs-1">
          ...
          <div id='selcontainer'>
            ...
            while ($r = $sth->fetch(PDO::FETCH_ASSOC)) {
              ...
              if (strlen($r['label'])) $label = "-" . $r['label'];
              else $label = "";
    ...
    <div class='blue' style='float:left;margin-left:10px;'>
      ...
      <table class='propstable' border=0>
        ...
        <tr>
          <td class='tdt'><label for=name>Preset Name:</label></td>
          <td><input size=8 value='<?php echo $name ?>' name=name></td>
          ...
          <td style='vertical-align:top;' rowspan=19 align=left>
            ...
            ?>
        <tr>
          <td class='tdt'><label for=lwidth><?php te("Width"); ?>:</label></td>
          <td><input size=4 value='<?php echo $lwidth ?>' name=lwidth>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=lheight><?php te("Height"); ?>:</label></td>
          <td><input size=4 value='<?php echo $lheight ?>' name=lheight>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=vpitch><?php te("Vert. Pitch"); ?>:</label></td>
          <td><input size=4 value='<?php echo $vpitch ?>' name=vpitch>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=hpitch><?php te("Horz. Pitch"); ?>:</label></td>
          <td><input size=4 value='<?php echo $hpitch ?>' name=hpitch>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=tmargin><?php te("Top Margin"); ?>:</label></td>
          <td><input size=4 value='<?php echo $tmargin ?>' name=tmargin>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=bmargin><?php te("Bottom Margin"); ?>:</label></td>
          <td><input size=4 value='<?php echo $bmargin ?>' name=bmargin>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=lmargin><?php te("Left Margin"); ?>:</label></td>
          <td><input size=4 value='<?php echo $lmargin ?>' name=lmargin>mm</td>
        </tr>
        <tr>
          <td class='tdt'><label for=rmargin><?php te("Right Margin"); ?>:</label></td>
          <td><input size=4 value='<?php echo $rmargin ?>' name=rmargin>mm</td>
        </tr>


        <tr>
          <td class=tdt><label for=border><?php te("Border Color (0-255)"); ?>:</label></td>
          <td title='0:black, 255:white'><input size=4 value='<?php echo $border ?>' name=border></td>
        </tr>
        <tr>
          <td class='tdt'><label for=padding><?php te("Text Padding"); ?>:</label></td>
          <td><input size=4 value='<?php echo $padding ?>' name=padding>mm</td>
        </tr>

        <tr>
          <td class='tdt'><label for=fontsize><?php te("FontSize"); ?>:</label></td>
          <td><input size=4 value='<?php echo $fontsize ?>' name=fontsize>pt <small>(1pt=0.352<span style='text-decoration:overline'>7</span> mm)</small></td>
        </tr>
        <tr>
          <td class='tdt'><label for=idfontsize><?php te("ID FontSize"); ?>:</label></td>
          <td><input size=4 value='<?php echo $idfontsize ?>' name='idfontsize'>pt</td>
        </tr>


        <tr>
          <td class='tdt'><label for=headerfontsize><?php te("Header FontSize"); ?>:</label></td>
          <td><input size=4 value='<?php echo $headerfontsize ?>' name='headerfontsize'>mm</td>
        <tr>
          <td class='tdt'><label for=barcodesize><?php te("Barcode Size"); ?>:</label></td>
          <td><input size=4 value='<?php echo $barcodesize ?>' name='barcodesize'>mm</td>

        <tr>
          <td class='tdt'><label for=image><?php te("Header Image"); ?>:</label></td>
          <td><input size=9 id='iimage' style='width:12em' value='<?php echo $image ?>' name='image'>
            <img id='theimage' width=25 height=25 src='<?php echo $image; ?>'>
          </td>
        <tr>
          <td class='tdt'><label for=imagewidth><?php te("Image Size (WxH)"); ?>:</label></td>
          <td>
            <input size=2 value='<?php echo $imagewidth ?>' name='imagewidth'> X <input size=2 value='<?php echo $imageheight ?>' name='imageheight'>mm
          </td>
        ...
        <tr>
          <td class='tdt'><label for=headertext><?php te("Header"); ?><br><small>_NL_ = newline</small>:</label></td>
          <td><textarea wrap=soft rows=2 name='headertext' cols=20><?php echo $headertext ?></textarea></td>
        </tr>


        <tr>
          <td class='tdt'><label for=wantbarcode><?php te("QR Barcode"); ?>:</label></td>
          <td><input id='wantbarcode' type=checkbox <?php if ($wantbarcode) echo "CHECKED"; ?> name=wantbarcode>
            <input title='<?php te("Text to prepend in QR barcode ID. <br>e.g. http://www.example.com/itdb/ ?action=edititem&id=") ?>' size=8 style='width:140px' value='<?php echo $qrtext ?>' name=qrtext>
          </td>
          </td>
        </tr>
        <tr>
          <td class='tdt'><label for=wantheadertext><?php te("Header Text"); ?>:</label></td>
          <td><input id='wantheadertext' type=checkbox <?php if ($wantheadertext) echo "CHECKED"; ?> name=wantheadertext></td>
        </tr>
        <tr>
          <td class='tdt'><label for=wantheaderimage><?php te("Header Image"); ?>:</label></td>
          <td><input id='wantheaderimage' type=checkbox <?php if ($wantheaderimage) echo "CHECKED"; ?> name=wantheaderimage></td>
        </tr>

        <tr>
          <td class='tdt'><label for=wantnotext><?php te("No Text"); ?>:</label></td>
          <td><input title='<?php te("Just print the barcode, no text") ?>' id='wantnotext' type=checkbox <?php if ($wantnotext) echo "CHECKED"; ?> name=wantnotext></td>
        </tr>
        <tr>
          <td class='tdt'><label for=wantraligntext><?php te("Text to the right of barcode"); ?>:</label></td>
          <td><input id='wantraligntext' type=checkbox <?php if ($wantraligntext) echo "CHECKED"; ?> name=wantraligntext></td>
        </tr>


        <tr>
          <td class='tdt'><label for=labelskip><?php te("Skip"); ?>:</label></td>
          <td title='<?php te("use when the top labels have already been printed"); ?>'><input size=4 value='<?php echo $labelskip ?>' name=labelskip> <?php te("labels"); ?></td>
        </tr>
      </table>
