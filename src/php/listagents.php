			...
			<table  class='display' width='100%' border=0 id='agentlisttbl'>
				...
				<tbody>
					...
					<tr id='trid{$r['id']}'>";
						echo "
						<td><a class='editid' href='$scriptname?action=editagent&amp;id=".$r['id']."'>{$r['id']}</a></td>\n";
						echo "
						<td style='padding-left:2px;padding-right:2px;'>$type</td>\n";
						echo "
						<td style='padding-left:2px;padding-right:2px;'>{$r['title']}</td>\n";
						echo "
						<td style='padding-left:2px;padding-right:2px;'>{$r['contactinfo']}</td>\n";
						echo "
						<td>\n";
						echo "
