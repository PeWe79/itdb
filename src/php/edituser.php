<?php 
	...
	if (isset($_GET['delid'])) {
		...
		echo "<a href='$scriptname?action=listusers'>Go here</a></body></html>"; 
		exit;
			...
			<table style='width:100%' border=0>
						...
						<table class="tbl2" style='width:300px;'>
							...
							<tr><td class="tdt">ID:</td>
								<td><input  style='display:none' type=text name='id' 
									value='<?php echo $id?>' readonly size=3><?php echo $id?>
								</td>
							</tr>
							<tr><td class="tdt"><?php te("Username");?>:</td>
				...
				<tr>
					<td colspan=2>
						...
						<?php 
						if ($id!=1)
						echo "<button type='button' onclick='javascript:delconfirm2(\"{$r['id']}\",\"$scriptname?action=$action&amp;delid=$id\",\"All items will be assigned to user [id:1].\");'>".
