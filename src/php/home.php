  ...
  <div style='clear:both'>
    ...
    <div class='bigblock'>
      ...
      <div class='bigblockdesc'>
        ...
        <?php te("H/W &amp; S/W Manufacturers &amp; Vendors, Buyers, Contractors"); ?>
      </div>
    </div>
    ...
    <div style='clear:both'>
      <div class='bigblock'>
        ...
        <div class='bigblocklinks'>
          <div>
            <a href='<?php echo $scriptname ?>?action=listracks'>
              <img class='bigblocklnk' src='images/big/search24.png'>
              <span class="lnktxt"><?php te("Find"); ?></span>
            </a>
          </div>
          <div>
            <a href='<?php echo $scriptname ?>?action=editrack&amp;id=new'>
              <img class='bigblocklnk' src='images/big/plus.png'>
              <span class="lnktxt"><?php te("Add"); ?></span>
            </a>
          </div>
        </div>
        <div class='bigblockdesc'>
      ...
      <div class='bigblock'>
        ...
        <div class='bigblocklinks'>
          ...
          <div>
            <a href='<?php echo $scriptname ?>?action=editlocation&amp;id=new'>
              <img class='bigblocklnk' src='images/big/plus.png'>
              <span class="lnktxt"><?php te("Add"); ?></span>
            </a>
          </div>
      ...
      <div class='bigblock'>
        ...
        <div class='bigblocklinks'>
          <div>
            <a title='<?php te("Select &amp; Print"); ?>' href='<?php echo $scriptname ?>?action=printlabels'>
              <span class='linktxt'><?php te("Labels"); ?></span>
            </a>
          </div>
        </div>
        <div class='bigblockdesc'>
