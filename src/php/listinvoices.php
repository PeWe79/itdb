...
?>
		...
		<h1>
			...
			<a title='<?php te("Add new Invoice");?>' href='<?php echo $scriptname?>?action=editinvoice&amp;id=new'><img border=0 src='images/add.png' ></a>
		</h1>
		...
		<div class='scrtblcontainerlist'>
			<table class="display" width='100%' border=0 id="invlisttbl">
				<thead>
					<tr>
						<th style='width:80px' nowrap><?php te("Edit ID");?></th>
						<th><?php te("Vendor");?></th>
						<th><?php te("Buyer");?></th>
						<th><?php te("Date");?></th>
