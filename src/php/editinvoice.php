  ...
  <div id="tab1" class="tab_content">
    <table class=tbl1 border=0>
      ...
      for ($lnk = "", $c = 0; $c < count($f); $c++) {
        ...
        if (strlen($ftitle)) $t = "<br>" . t("Title") . ":$ftitle";
        else $t = "";
      ...
      <tr>
        <td class="tdtop">
          <table class="tbl2" width='100%'>
            ...
            <tr>
              <td class="tdt"><?php te("Order Num"); ?>*:</td>
              <td><input class='input2 mandatory' validate='required:true' size=20 type=text name='number' value="<?php echo $number ?>"></td>
            </tr>
            <tr>
              <td class="tdt"><?php te("Date"); ?>*:</td>
              <td><input class='dateinp mandatory' validate='required:true' size=10 id='date' title='<?php echo $datetitle ?>' type=text name='date' value='<?php echo $d ?>'>
              </td>
            </tr>
...
<table>
  <tr>
    <td>
      <button type="submit">
        <img src="images/save.png" alt="Save"> <?php te("Save Invoice"); ?>
      </button>
    </td>
