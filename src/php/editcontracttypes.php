					...
					<table border=0 class='brdr' >
						...
						<?php 
							...
							if ($dbid>$internaltypes) //change this to remove X from internal types
								echo "
						<tr>
							<td><a href='javascript:delconfirm(\"$itype\",\"$scriptname?action=$action&amp;deltype=$dbid\");'><img title='delete ID:$dbid' src='images/delete.png' border=0></a></td>";
							else 
								echo "
						<tr><td title='ID:$dbid'>-</td>";
								...
								echo "
							<td><input size=30 type='text' name='descs[]' ".
								"value=\"".$contracttypes[$i]['name']."\">".
								"<input type=hidden name='ids[]' value='$dbid' >";
								echo "
							</td>";
								echo "
							<td><button type=submit name='subtypesof' value='$dbid'>".t("View/Edit Subtypes")."</button></td>";
								echo "
						</tr>";
						...
						<tr>
							<td><?php te("New");?></td>
							<td><input size='30' name='newtype' type='text'></td>
						</tr>

						<tr>
							<td style='text-align: right' colspan=4><button name='savetype' type="submit"><img src="images/save.png" alt="Save" > <?php te("Save");?></button></td>
						</tr>
						<!-- </form> -->
					</table>
				</div>
					...
					<form method=post name='subtypeaddfrm'>
						...
						<table class='brdr'>
							<tr>
								<th>&nbsp;</th>
								<th>ID</th>
								<th><?php te("Subtypes of  type ");?><?php echo $subtypesof?><?php te("Names");?></th>
							</tr>
							<?php 
								$subtypesof=$_POST['subtypesof'];
								...
								echo "
							<tr>
								<td><a href='javascript:delconfirm(\"$itype\",\"$scriptname?action=$action&amp;delsubtype=$dbid\");'><img title='delete' src='images/delete.png' border=0></a></td>";
								echo "
								<td>$dbid</td>".
								"<td><input size=30 type='text' name='subdescs[]' ".
								"value=\"".$contractsubtypes[$i]['name']."\">".
								"<input type=hidden name='subids[]' value='$dbid' ></td>
							</tr>";
							...
							<tr>
								<td>&nbsp;</td>
								<td><?php te("New");?></td>
								<td><input size='30' name='newsubtype' type='text'></td>
							</tr>
							<tr>
								<td style='text-align: right' colspan=4><button type='submit' name='savesubtype'><img src='images/save.png' alt='Save' > <?php te("Save");?></button></td>
							</tr>
							<?php 
								}
							?>
