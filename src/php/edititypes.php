		...
		<script type="text/javascript">
			...
			<?php 
				...
				//form submitted
				if  (isset($deltype) && $deltype<$internaltypes) { 
				...
				echo "
		<form method='post' id='typeaddfrm' action='?action=edititypes&amp;dlg=$dlg' name='typeaddfrm'>";
			...
			<table id='itypetbl' class='brdr' border=0 >
				<thead>
					<tr>
						...
						<th><?php te("Supports<br>Software");?><sup>1</sup></th>
					</tr>
				</thead>
				<tbody>
					<?php
						...
						for ($i=0;$i<count($fixtypes);$i++) {
							...
							echo "
					<tr>
						<td title='Delete ID:$dbid'><a href='javascript:delconfirm(\"$itype\",\"$scriptname?action=edititypes&amp;deltype=$dbid\");'><img title='delete' src='images/delete.png' border=0></a></td>";
							else echo "
					<tr><td>--</td>";
					...
					<tr>
						<td colspan=1><?php te("New");?>:</td>
						<td><input name='newtype' type='text'></td>
						<td>
							<select name='newhassoftware'>
					...
					<tr>
						<td style='text-align: right' colspan=4><button type="submit"><img src="images/save.png" alt="Save" > Save</button></td>
					</tr>
					<tr>
						<td style='text-align: left' colspan=4>
							<sup>1</sup>
							<?php te("Select 'YES' if software can be installed <b>on</b> this item.<br> Only items supporting software are listed when <br>performing software - item associations");?>
