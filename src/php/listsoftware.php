    ...
    <tbody>
      ...
      while ($r = $sth->fetch(PDO::FETCH_ASSOC)) {
        ...
        for ($i = 0; $i < $nitems; $i++) {
          ...
          if ($rstatus == 1) {
            $attr = "style='background-color:green;font-weight:bold;color:#efefef' title='Status: Stored'";
          } elseif ($rstatus == 2) {
            $attr = "style='background-color:red;font-weight:bold;' title='Status: Defective'";
          } elseif ($rstatus == 3) {
            $attr = "style='background-color:#cecece;font-weight:bold;' title='Status: Obsolete'";
          } else {
            $attr = " title='Status: In Use' ";
          }
      ...
      ?>
        ...
        <tr>
          <td>
            <div class='editid'><a title='<?php te("Edit Software"); ?>' href='<?php echo $scriptname ?>?action=editsoftware&amp;id=<?php echo $r['id'] ?>'><?php echo $id ?></a></div>
          </td>
          ...
          <td>
            <div class='scrlswlist'><?php echo $institems ?></div>
          </td>
        </tr>
      <?php
      } //while
