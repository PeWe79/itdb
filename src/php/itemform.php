    ...
    <form class='frm1' enctype='multipart/form-data' method=post name='additmfrm' id='mainform'>
      ...
      <table border='0' class=tbl1>
        <tr>
          <td class='tdtop'>
            <table border='0' class=tbl2>
              <tr>
                <td colspan=2>
                  <h3><?php te("Intrinsic Properties"); ?></h3>
                </td>
              </tr>
        ...
        <tr>
          ...
          //usize
          ?>
          <td class='tdt' class='tdt'><?php te("Size (U)"); ?>:</td>
          <td>
            <select name='usize'>
              <option value=''><?php te("Select"); ?></option>
        ...
        <tr>
          <td class='tdt'><?php te("S/N"); ?>:</td>
          <td><input type=text value='<?php echo $sn ?>' name='sn'></td>
        </tr>
        <tr>
            ...
            <td>
              <select validate='required:true' class='mandatory' name='status'>
                ...
                for ($i = 0; $i < count($statustypes); $i++) {
                  $dbid = $statustypes[$i]['id'];
                  $itype = $statustypes[$i]['statusdesc'];
                  $s = "";
      ...
      <tr>
        ...
        <td title='<?php te("Special maintenance instructions"); ?>'>
          <textarea wrap='soft' class=tarea1 name='maintenanceinfo'><?php echo $maintenanceinfo ?></textarea>
        </td>
      </tr>

      <tr>
        <td colspan=2 style='padding-top:10px'>
          <h3><?php te("Accounting"); ?></h3>
        </td>
      </tr>
      <tr>
      ...
      <td class='tdtop'>
        <table border='0' class=tbl2> <!-- 3-Network -->
          ...
          <tr>
            <td class='tdt'>MACs:</td>
            <td><input type=text size=15 value='<?php echo $macs ?>' name='macs'></td>
          </tr>
          <tr>
            <td class='tdt'>IPv4:</td>
            <td><input type=text size=15 value='<?php echo $ipv4 ?>' name='ipv4'></td>
          </tr>
          <tr>
            <td class='tdt'>IPv6:</td>
            <td><input type=text size=15 value='<?php echo $ipv6 ?>' name='ipv6'></td>
          </tr>
          <tr>
          ...
          <tr>
            <td class='tdt'><?php te("Ptch.PnlPrt"); ?>:</td>
          ...
          <div class='scrltblcontainer'>
            <table width='100%' class='brdr' id='itemslisttbl'>
              ...
              <tbody>
                ...
                $error = $dbh->errorInfo();
                if ($error[0] && isset($error[2])) echo "Error ei0:" . $error[2] . "<br>";
