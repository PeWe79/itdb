<script language="javascript">
  ...
  $(document).ready(function() {
    ...
    $("#caddrow").click(function($e) {
      ...
      $(".dateinp").mask('<?php echo $maskdateparam ?>', {
        placeholder: "_"
      });
    });
    ...
    $("#ev_dialog").dialog({
      ...
      modal: true,
      position: 'center',
      open: function(event, ui) { // fill in values in form fields from table row
              ...
              <td>
                ...
                <select class='mandatory' validate='required:true' name='typex'>
                  ...
                  for ($i = 0; $i < count($contracttypes); $i++) {
                    ...
                    if (($r['type'] == $dbid) && (!is_numeric($r['subtype']))) $s = " SELECTED ";
                    else $s = "";
                    ...
                    for ($i2 = 0; $i2 < count($contractsubtypes); $i2++) {
                      ...
                      $itype2 = ($contractsubtypes[$i2]['name']);
                      $s = "";
